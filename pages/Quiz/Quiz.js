...
//   console.log(currentExperience, experienceToNextLevel)
  useEffect(() => {
    ...
    const fetchUserExperience = async () => {
        try {
            ...
            //   console.log('fetching user exp p', userExperience)
  ...
  const handleSubmitAnswer = async () => {
    ...
    const baseExperiencePoints =
      difficultyPoints[currentQuestion.difficulty_id];
    const experiencePoints = hintUsed
      ? baseExperiencePoints / 2
